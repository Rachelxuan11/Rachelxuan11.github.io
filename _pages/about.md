...
I am currently a postdoctoral fellow in [Assured Information Management and Sharing (AIMS)](http://www.cs.emory.edu/site/aims/people.html) at the Computer Science Department of Emory University, supervised by [Prof. Li Xiong](http://www.cs.emory.edu/~lxiong/).
Previously, I received my Ph.D. from the School of Information, Renmin University of China, under the supervision of [Prof. Hong Chen](http://info.ruc.edu.cn/Home/Faculty/Departments/ComputerScienceandTechnology/fad56fc492784d1fa87f662044649b2f.blk.htm).
During my Ph.D. study, I was a research intern at Amazon AWS AI Lab and Microsoft Research Asia.
I earned my Bachelor's degree from China University of Petroleum, during which I was a visiting student at the University of Calgary.
...
My research focuses on **privacy-preserving machine learning**, with an emphasis on differential privacy, federated learning, and privacy risks in large language models. I work on both auditing privacy risks and developing defenses that deliver privacy guarantees while remaining efficient, inclusive, and practically deployable. My recent focuses include:
* **Trustworthy LLMs & Foundation Models:** Auditing emerging privacy risks (S&P'26, CCS'24); preventing privacy leakage and unauthorized exploitation (NDSS'26, ACL'25).
* **Differentially Private Optimization:** Designing hyperparameter-free and utility-aware DP algorithms for general-purpose training (ICLR'25, ACM MM'25).
* **Privacy-Preserving Federated Learning:** Building private, efficient, and inclusive FL systems across heterogeneous devices (SIGKDD'23, SIGKDD'22, AAAI'21).
...
<div style="background-color: #f9f9f9; padding: 15px; border-left: 5px solid #007bff; margin-top: 20px; margin-bottom: 20px;">
  ...
  I am always happy to chat. Whether you are looking for a research collaborator, want to discuss ideas, or just want a quick chat — feel free to reach out by <strong><a href="https://forms.gle/k4zqoAE6EHFhBbDw7" target="_blank">filling this quick form</a></strong> to help us align efficiently!
</div>
...
# 🎖 Honors and Awards
- Outstanding Paper in Generation Theme, ACM MM, 2025
